        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-danger ml-auto" href="{{ route('admin.user_verifications.edit', $userVerification) }}">
                        <i class="far fa-edit mr-sm-1"></i>
                        <span class="d-none d-sm-inline">Update</span>
                    </a>
                    <a class="btn btn-info ml-2" href="{{ route('admin.user_verifications.index') }}">
