@extends('layouts.app')
<title>{{ env('APP_NAME') }} | Kategori postingan</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-center align-items-center">
                                <span class="d-none d-sm-block my-auto text-secondary mr-auto">Displaying {{ $postCategories->count() }} of {{ $postCategories->total() }} records</span>
