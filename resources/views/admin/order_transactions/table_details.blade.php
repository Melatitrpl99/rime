@php
    $role = $orderTransaction->order->user->hasRole('reseller');
@endphp
<table class="table table-sm table-borderless table-striped" id="transaction_detail-table" style="min-width: 1024px">
    <thead>
        <tr>
    ...
    <tbody>
        @foreach($orderTransaction->order->products as $product)
            <tr>
