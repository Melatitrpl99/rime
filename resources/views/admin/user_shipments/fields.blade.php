...
<!-- Is Default Field -->
<div class="form-group col-12 col-sm-6">
    <label>Jadikan sebagai default?</label>
    <div class="custom-control custom-checkbox">
        {!! Form::hidden('is_default', 0) !!}
        {!! Form::checkbox('is_default', '1', null, ['class' => 'custom-control-input custom-control-input-info', 'id' => 'is_default']) !!}
        {!! Form::label('is_default', 'Ya', ['class' => 'custom-control-label']) !!}
    </div>
</div>
