        ...
        <tfoot>
            <tr class="border-top">
                ...
                <th>
                    ...
                    {!! Form::text('calc', Route::currentRouteName() == 'admin.carts.edit' ? rp($cart->total) : '', ['class' => 'form-control-plaintext text-right m-0 p-0 border-0', 'readonly' => true, 'id' => 'calc']) !!}
                </th>
            </tr>
        </tfoot>
    </table>
