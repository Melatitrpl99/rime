<table class="table table-sm table-borderless table-striped" id="cart_detail-table">
    <thead>
        <tr>
            ...
            <th class="py-2 border-bottom text-center" width="150">Harga</th>
            <th class="py-2 border-bottom text-center" width="50">Jumlah</th>
    ...
    <tfoot>
        ...
        <th class="py-2 border-top text-center">Total</th>
